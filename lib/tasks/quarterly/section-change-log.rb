module SectionChangeLog
  def run_section_change_log
    run_section "製作 Change Log (section-change-log.rb)" do
      step_convert_xml_to_normal
      step_diff
      step_convert_diff_txt_to_html
      step_divide_into_two_parts
      step_convert_html_to_pdf
    end
  end

  def step_convert_diff_txt_to_html
  ...
  def step_convert_xml_to_normal
  ...
  def step_divide_into_two_parts
